...
object GBTLearnerWithMatching extends Learner {
  private var learner: GBTClassificationModel = _
  ...
  def load_learner(): Unit = {
    ...
    learner = GBTClassificationModel.load(learner_loc)
